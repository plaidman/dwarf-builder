...
-(void)processInitTxt {
    ...
    NSDictionary *changes = [NSDictionary dictionaryWithObjectsAndKeys:
        ...
        [self stringToInit:[settings windowWidth] optionName:@"GRAPHICS_WINDOWEDX"],
            @"\\[GRAPHICS_WINDOWEDX:.*\\]",
        [self stringToInit:[settings windowHeight] optionName:@"GRAPHICS_WINDOWEDY"],
            @"\\[GRAPHICS_WINDOWEDY:.*\\]",
...
-(void)processDInitTxt {
    ...
    NSDictionary *changes = [NSDictionary dictionaryWithObjectsAndKeys:
        ...
        [self boolToInit:[settings variedGroundTiles] optionName:@"VARIED_GROUND_TILES"],
            @"\\[VARIED_GROUND_TILES:.*\\]",
        ...
        [self childToInit:[settings childHardCap] percentage:[settings childPercentageCap]],
            @"\\[BABY_CHILD_CAP:.*\\]",
